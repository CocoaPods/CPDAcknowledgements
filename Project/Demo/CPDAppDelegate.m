...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    CPDContribution *orta = [[CPDContribution alloc] initWithName:@"Orta" url:@"http://orta.github.io" role:@"Behind a wheel"];
    ...
    CPDContribution *fabio = [[CPDContribution alloc] initWithName:@"Fabio Pelosin" url:@"http://twitter.com/fabiopelosin" role:@"Back Seat Driver"];
    ...
    CPDContribution *kyle = [[CPDContribution alloc] initWithName:@"Kyle Fuller" url:@"http://twitter.com/kylefuller" role:@"Somewhere in the boot"];
